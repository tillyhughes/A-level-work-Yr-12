...
class ToDo (tk.Frame):
    def __init__(self, parent):
        ...
        self.delete = tk.Button(self.last_row, text="Delete", command=self.delete_entry)
        self.add = tk.Button(self.last_row, text="Add", command=self.add_entry)
        self.new = tk.Entry(self.last_row)

        self.delete.grid(row=0, column=0, sticky="")
...
if __name__ == "__main__":
    ...
    #my_frame.add_another_entry("2")
    #my_frame.add_another_entry("3")
